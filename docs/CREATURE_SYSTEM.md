...
| 种族 | 特点 | 代表生物 |
|------|------|----------|
| 🏰 城堡 | 均衡型 | 枪兵、弓箭手、狮鹫、骑士、天使 |
| 💀 墓园 | 亡灵大军 | 骷髅、僵尸、吸血鬼、巫妖、骨龙 |
| 🔥 地狱 | 高攻击 | 小恶魔、火精灵、恶魔、恶魔领主 |
| 🌲 森林 | 远程优势 | 精灵、树人、独角兽、金龙 |
| ⚔️ 据点 | 近战爆发 | 哥布林、狼骑兵、半兽人、比蒙 |
...
const CREATURES = {
  castle: [
    { id: 'pikeman', name: '枪兵', icon: '🗡️', tier: 1 },
    { id: 'archer', name: '弓箭手', icon: '🏹', tier: 1 },
    { id: 'griffin', name: '狮鹫', icon: '🦅', tier: 2 },
    { id: 'knight', name: '骑士', icon: '🐴', tier: 3 },
    { id: 'angel', name: '天使', icon: '👼', tier: 4 },
  ],
  necropolis: [
    { id: 'skeleton', name: '骷髅', icon: '💀', tier: 1 },
    { id: 'zombie', name: '僵尸', icon: '🧟', tier: 1 },
    { id: 'vampire', name: '吸血鬼', icon: '🧛', tier: 2 },
    { id: 'lich', name: '巫妖', icon: '☠️', tier: 3 },
    { id: 'bonedragon', name: '骨龙', icon: '🐉', tier: 4 },
  ],
  // ... 其他种族
};
```
